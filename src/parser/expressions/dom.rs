...
impl ParserEngine {
    pub fn parse_element_expression(
        &mut self,
        pair: Pair<'static, Rule>,
    ) -> ast::ElementExpression {
    ...
    fn parse_element(&mut self, pair: Pair<'static, Rule>) -> ast::Element {
    ...
    fn parse_void_element(&mut self, pair: Pair<'static, Rule>) -> ast::VoidElement {
    ...
    fn parse_start_tag(&mut self, pair: Pair<'static, Rule>) -> (String, Vec<ast::Attribute>) {
    ...
    fn parse_attribute(&mut self, pair: Pair<'static, Rule>) -> ast::Attribute {
    ...
    fn parse_attribute_value(&mut self, pair: Pair<'static, Rule>) -> ast::AttributeValue {
    ...
    fn parse_child(&mut self, pair: Pair<'static, Rule>) -> ast::ElementChild {
    ...
    fn check_end_tag(&mut self, pair: Pair<'static, Rule>, expected: &str) {
