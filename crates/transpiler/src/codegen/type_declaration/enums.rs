...
fn variants_to_swc_switch(variants: &Vec<ast::VariantDefinition>) -> Option<swc::SwitchStmt> {
...
fn variant_to_swc_switch_case(variant: &ast::VariantDefinition) -> swc::SwitchCase {
    swc::SwitchCase {
        span: DUMMY_SP,
...
fn variant_to_swc_constructor_stmts(fields: &Vec<ast::StructDefinitionField>) -> Vec<swc::Stmt> {
    fields
        .iter()
        .enumerate()
